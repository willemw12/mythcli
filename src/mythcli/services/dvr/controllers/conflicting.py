...
DEFAULT_RSS_CHANNEL_DESCRIPTION = "List of conflicting recordings in RSS 2.0 format."
...
def add_subparser(subparsers):
    parser = subparsers.add_parser("conflicting", description=DEFAULT_RSS_CHANNEL_DESCRIPTION, help="list conflicting recordings")
