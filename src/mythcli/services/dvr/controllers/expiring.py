...
DEFAULT_RSS_CHANNEL_DESCRIPTION = "List of expiring recordings in RSS 2.0 format."
...
def add_subparser(subparsers):
    parser = subparsers.add_parser("expiring", description=DEFAULT_RSS_CHANNEL_DESCRIPTION, help="list conflicting recordings")
