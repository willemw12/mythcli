...
DEFAULT_RSS_CHANNEL_DESCRIPTION = "List of upcoming recordings in RSS 2.0 format."
...
def add_subparser(subparsers):
    parser = subparsers.add_parser("upcoming", description=DEFAULT_RSS_CHANNEL_DESCRIPTION, help="list upcoming recordings")
